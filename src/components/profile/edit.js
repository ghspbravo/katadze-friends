		...
		<form>
			<section className="jumbotron">
				...
				<div className="row content">
					...
					<div className="offset-1 col-8"><input value={user.first_name} disabled className='col-12' id='name' type="text" /></div>

					<div className="col-3 text-right"><label htmlFor='surname'><p className="small">Фамилия</p></label></div>
					<div className="offset-1 col-8"><input value={user.last_name} disabled className='col-12' id='surname' type="text" /></div>
					...
					<div className="offset-1 col-8"><input value={user.date_birth} disabled className='col-md-5 col-12' id='burthdate' type="date" /></div>
					...
					<div className="offset-1 col-8"><select value={user.currency} disabled className='col-md-5 col-12' id='currency'>
					...
					<div className="offset-1 col-8"><input value={user.residence} disabled className='col-12' id='city' type="email" placeholder='Город' /></div>
