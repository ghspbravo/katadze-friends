		...
		<form>
			<section className="jumbotron">
				...
				<div className="row content">
					...
					<div className="offset-1 col-8"><select className='col-md-5 col-12' id='gender'>
					...
					<div className="offset-1 col-8"><input className='col-md-5 col-12' id='burthdate' type="date" /></div>
					...
					<div className="offset-1 col-8"><select className='col-md-5 col-12' id='language'>
					...
					<div className="offset-1 col-8"><select className='col-md-5 col-12' id='currency'>
