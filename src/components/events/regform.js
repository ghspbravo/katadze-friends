...
import { formatToPhone, enforceFormat, formatToDate, showSuccess } from '../../functions'
import errorMessage from '../errorMessage';

export default (handeInput, handleSubmit, errors, success, fields, changeValue) => {
    return (success
        ? showSuccess('Увидимся в горах!')
        : <section>
