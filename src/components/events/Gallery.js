        ...
        return (
            <section>
                ...
                <div className="container" style={{ boxShadow: '0px 0px 50px' }}>
                    <div className="row">
                        <div onClick={() => this.change((this.images.length + this.state.current - 1) % this.images.length)} style={{cursor: 'pointer', backgroundColor: 'rgba(255,255,255,0.6)'}} className="d-none d-sm-flex no-padding col align-center justify-center">
